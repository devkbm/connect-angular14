...
@Component({
  selector: 'app-mat-list-road-address',
  template: `
    ...
    <div>
      {{list.selectedOptions.selected[0] | json}}

      <mat-selection-list #list [multiple]="false">
        <mat-list-option *ngFor="let item of _data?.juso" [value]="item">
...
export class MatListRoadAddressComponent implements OnInit {
